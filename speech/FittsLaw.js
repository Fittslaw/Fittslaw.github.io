    ...
    if (id == currentCircle){
        ...
        if (circleIds.length != 0){
            ...
            for (var i=0;i<mt.length;i++){
                if (mt[i]>2500){
                    console.log("mt1",mt);
                    console.log('Please start the experiment again. One or more of the movement times recorded has been irregular.');
                    mt=[];
                    console.log("mt2",mt);
                    break;
                }
